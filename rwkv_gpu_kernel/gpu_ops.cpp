...
PYBIND11_MODULE(gpu_ops, m) {
  ...
  m.def("create_rwkv_descriptor",
        [](int B, int T,int C, int H, gpu_ops::ElementType input_type,gpu_ops::ElementType output_type) {
          return gpu_ops::PackDescriptor(gpu_ops::WKVDescriptor{B, T, C, H, input_type, output_type});
        });
